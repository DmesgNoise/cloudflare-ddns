import os, json, requests, threading, sys
...
def load_config():
    default = {"token": "", "zone_id": "", "zone_name": "", "record_id": "", "timezone": "UTC", "proxied": False, "interval": "60"}
...
def api_fetch_zones():
    ...
    resp = requests.get("https://api.cloudflare.com/client/v4/zones", headers={"Authorization": f"Bearer {token}"})
